  ...
  function settingForm() {
    ...
    if (config.Setting.useModal) {
      ...
      var titleTxt = document.createTextNode(
        config.ModalContener.titleLang[langRef]
      );
    ...
    var legendText = document.createTextNode(
      config.ContrastLegend.lang[langRef]
    );
    ...
    var defaultCText = document.createTextNode(
      config.DefaultContrastCheckbox.lang[langRef]
    );
    ...
    if (config.Setting.useExtendContrast) {
      ...
      var defaultCText = document.createTextNode(
        config.HighContrastCheckbox.lang[langRef]
      );
      CLabel.appendChild(defaultCText);
      fieldset.appendChild(CInput);
      fieldset.appendChild(CLabel);
    ...
    var defaultCText = document.createTextNode(
      config.InvertContrastCheckbox.lang[langRef]
    );
    CLabel.appendChild(defaultCText);
    fieldset.appendChild(CInput);
    fieldset.appendChild(CLabel);
    ...
    var legend = document.createElement("legend");
    var legendText = document.createTextNode(
      config.DyslexiaLegend.lang[langRef]
    );
    legend.appendChild(legendText);
    fieldset.appendChild(legend);
    //default
    ...
    var defaultCText = document.createTextNode(
      config.DefaultFontCheckbox.lang[langRef]
    );
    CLabel.appendChild(defaultCText);
    fieldset.appendChild(CInput);
    fieldset.appendChild(CLabel);
    ...
    var defaultCText = document.createTextNode(
      config.DyslexiaFontCheckbox.lang[langRef]
    );
    CLabel.appendChild(defaultCText);
    fieldset.appendChild(CInput);
    fieldset.appendChild(CLabel);
    ...
    var legend = document.createElement("legend");
    var legendText = document.createTextNode(
      config.LineSpacingLegend.lang[langRef]
    );
    legend.appendChild(legendText);
    fieldset.appendChild(legend);
    //default
    ...
    var defaultCText = document.createTextNode(
      config.DefaultLineSpacingCheckbox.lang[langRef]
    );
    CLabel.appendChild(defaultCText);
    fieldset.appendChild(CInput);
    fieldset.appendChild(CLabel);
    ...
    var defaultCText = document.createTextNode(
      config.DyslexiaLineSpacingCheckbox.lang[langRef]
    );
    CLabel.appendChild(defaultCText);
    fieldset.appendChild(CInput);
    fieldset.appendChild(CLabel);
